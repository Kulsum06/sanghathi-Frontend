...
const EMPTY_ROW = { ProffessionalBodyName: "", UniqueID: "", registeredDate: null };
...
export default function ProffessionalBodiesEvents() {
  ...
  useEffect(() => {
    if (error) enqueueSnackbar("Error fetching professional bodies data", { variant: "error" });
  }, [error, enqueueSnackbar]);

  const onSubmit = async (formData) => {
    try {
      await api.post("/proffessional-body/proffessionalbody", { proffessionalbodies: formData.proffessionalbodies, userId: user._id });
